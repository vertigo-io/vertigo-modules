...
public final class OActivityWorkspaceDAO extends DAO<OActivityWorkspace, java.lang.Long> implements StoreServices {
 ...
 "         	 and   acw.IS_IN = #workspaceIn#",
	...
	@io.vertigo.datafactory.task.proxy.TaskOutput(smartType = "STyDtOActivityWorkspace", name = "dtOActivityWorkspace")
	public Optional<io.vertigo.orchestra.domain.execution.OActivityWorkspace> getActivityWorkspace(@io.vertigo.datafactory.task.proxy.TaskInput(name = "aceId", smartType = "STyOIdentifiant") final Long aceId, @io.vertigo.datafactory.task.proxy.TaskInput(name = "workspaceIn", smartType = "STyOBooleen") final Boolean workspaceIn) {
