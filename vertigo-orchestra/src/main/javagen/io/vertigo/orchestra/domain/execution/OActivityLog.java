...
public final class OActivityLog implements Entity {
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyOIdentifiant", label = "ActivityExecution", fkDefinition = "DtOActivityExecution", cardinality = io.vertigo.core.lang.Cardinality.ONE )
