...
public final class OActivityExecution implements Entity {
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyOIdentifiant", label = "Activity", fkDefinition = "DtOActivity", cardinality = io.vertigo.core.lang.Cardinality.ONE )
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyOIdentifiant", label = "Processus", fkDefinition = "DtOProcessExecution", cardinality = io.vertigo.core.lang.Cardinality.ONE )
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyOIdentifiant", label = "Node", fkDefinition = "DtONode", cardinality = io.vertigo.core.lang.Cardinality.ONE )
	 ...
	 */
	@io.vertigo.datamodel.data.stereotype.ForeignKey(smartType = "STyOCodeIdentifiant", label = "ExecutionState", fkDefinition = "DtOExecutionState", cardinality = io.vertigo.core.lang.Cardinality.ONE )
