...
public class EasyFormsDesignerServices implements IEasyFormsDesignerServices {
	...
	*/
	...
	public Long saveNewForm(final EasyForm easyForm) {
		final List<EasyFormsTemplateItemField> templateFields = new ArrayList<>();
		/*
		for (final EasyFormsFieldUi fieldUi : fields) {
			...
			templateFields.add(new EasyFormsTemplateItemField(fieldUi.getFieldCode(), fieldType)
		...
		*/
		//easyForm.setTemplate(new EasyFormsTemplate(templateFields)); // TODO
