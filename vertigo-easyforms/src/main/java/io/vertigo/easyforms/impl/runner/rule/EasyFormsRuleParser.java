...
public class EasyFormsRuleParser {
	...
	private static Object extractValue(final String initialKey, final String parsedKey, final String key, final Object data) {
		...
		if (keys.length == 1) {
			...
			return extractValue(initialKey, currentGlobalKey, restOfKey, getValue(data, prefix));
		}
	}
