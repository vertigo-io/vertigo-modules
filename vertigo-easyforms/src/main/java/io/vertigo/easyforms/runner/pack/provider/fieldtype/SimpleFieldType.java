...
public class SimpleFieldType implements IEasyFormsFieldTypeDefinitionSupplier {
	...
	private final Enum<?> smartType;
	private final EnumDefinition<EasyFormsUiComponentDefinition, ?> uiComponent;

	public SimpleFieldType(final Enum<?> smartType, final EnumDefinition<EasyFormsUiComponentDefinition, ?> uiComponent) {
		this(DEFAULT_CATEGORY, smartType, uiComponent);
	}

	public SimpleFieldType(final String category, final Enum<?> smartType, final EnumDefinition<EasyFormsUiComponentDefinition, ?> uiComponent) {
